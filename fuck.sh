...
echo " "
echo "-------------------------- |----------------------"|lolcat
echo " 01) Red Hawk              | 11)ViSql"
echo "-------------------------- |----------------------"|lolcat
echo " 02) D-Tech                | 12)Weeman"
echo "---------------------------|----------------------"|lolcat
echo " 03) Hunner                | 13)Wfdroid"
echo "---------------------------|----------------------"|lolcat
echo " 04) Wpscan                | 14)Hack Facebook"
echo "---------------------------|----------------------"|lolcat
echo " 05) Lazy Sqlmap           | 15)ngrok"
echo "---------------------------|----------------------"|lolcat
echo " 06) Webdav                | 16)Exploiter SQL Lokomedia"
echo "---------------------------|----------------------"|lolcat
echo " 07) Metasploit            | 17)Hasbuster"
echo "---------------------------|----------------------"|lolcat
echo " 08) Kali Nethunter        | 18)Spam WhatsApp"
echo "---------------------------|----------------------"|lolcat
echo " 09) Ubuntu                | 19)Hack Cctv"
echo "---------------------------|----------------------"|lolcat
echo " 10) Denger Musik Youtube  | 20)Author"
echo "---------------------------|----------------------"|lolcat
echo "\                          | 21)Maen Games "
echo " \      COMING SOON        |----------------------"|lolcat
echo "  \________________________| 22)Keluar Aja Lah"
echo "                           |----------------------"|lolcat
read pil 
